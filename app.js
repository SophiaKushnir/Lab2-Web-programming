...
let ShipOnPiers = [new ShipOnPier([20, 69], 32), new ShipOnPier([95], 14)]

let ports = [new Port('Stambul', 'Turkey', 5496, 'Helaldi 7', []),
new Port('Miami', 'USA', 1234, 'WestLand 3', [14]),
new Port('Tiba', 'Japan', 7542, 'Chinako 1', []),
new Port('Rotterdam', 'Netherlands', 5486, 'Bestenmarkt 57', [16]),
new Port('Marsel', 'France', 2798, 'Muftar 21',[])]

let ships = [
    new Ship('Kleymor', 20, 'Thailand', 22,
        [
            new Log(21, new Date(2020, 10, 11), new Date(2020, 12, 10)),
            new Log(32, new Date(2021, 2, 15), new Date(2021, 3, 21))
        ]),
    
    new Ship('Piligrim', 95, 'China', 31,
        [
            new Log(14, new Date(2021, 2, 3), new Date(2021, 4, 11))
        ]),
        
    new Ship('Arabella', 69, 'Dominikana', 28,
        [
            new Log(16, new Date(2020, 3, 30), new Date(2020, 9, 26)),
            new Log(32, new Date(2021, 1, 30), new Date(2021, 3, 22))
        ]),

    new Ship('Dunkan', 100, 'Iran', 15,
        [
            new Log(14, new Date(2019, 12, 30), new Date(2020, 5, 17)),
            new Log(2, new Date(2020, 4, 30), new Date(2020, 9, 17))
        ]),

    new Ship('Arizona', 37, "Singapur", 10,
        [
            new Log(16, new Date(2017, 12, 30), new Date(2020, 5, 17)),
            new Log(14, new Date(2018, 4, 30), new Date(2019, 9, 17))
        ])]

let piers = [new Pier('Klevedon', 23, 5),
    new Pier('Soppot', 16, 7),
    new Pier('SanderLand', 21, 6),
    new Pier('Umlanga', 14, 9),
    new Pier('Ride', 32, 10)]
